...
public enum RefundOptionsCodeType {
     ...
     * 
     * 						<span class="tablenote"><b>Note:</b>
     * 						US sellers opted into Hassle-free returns, that are willing to refund buyers or offer an identical replacement item, should use the 'MoneyBackOrReplacement' value instead of 'MoneyBackOrExchange'.
     * 						</span>
     ...
     * 
     * 						<span class="tablenote"><b>Note:</b>
     * 						This value is only available on the US site. US sellers opted into Hassle-free returns should use this value (and not 'MoneyBackOrExchange') if they are willing to refund buyers or offer an identical replacement item.
     * 						</span>
     * 						This value indicates that the seller will refund the buyer the cost of the item (excluding shipping and handling costs and any restocking fee) through eBay Hassle-free returns, or the seller will replace the returned item with another identical item.
     * 						<br><br>
