...
public enum FeatureIDCodeType {
     ...
     * 							This value will be enabled with version 935. For those using versions older than 935, this value will not be available for use.
     * 						</span>
     * 						<br>
     * 						If this value is specified, the <b>Category.DigitalGoodDeliveryEnabled</b> fields in the <b>GetCategoryFeatures</b> response will indicate that digital gift cards can be listed in the corresponding category. A 'false' value in this field indicates that digital gift cards may not be listed in the category.
     * 						<br/><br/>
