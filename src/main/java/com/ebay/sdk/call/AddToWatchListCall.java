 ...
 * <br> <B>Output property:</B> <code>ReturnedWatchListMaximum</code> - This integer value indicates the maximum number of items allowed in a user's Watch Lists. This value can vary by site and is subject to change. Currently on the US site, up to 200 items can be on the user's Watch List at any given time.
 * 
 * @author Ron Murphy
 * @version 1.0
 */
